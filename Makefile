...
.PHONY : veryclean
veryclean: clean
	rm -f alljobs.$(suffix).csv alljobs?.$(suffix).csv project.$(suffix).csv project-info.$(suffix).csv usernames.$(suffix).csv ams-p*.$(suffix).csv depend.$(suffix).csv ngpus.$(suffix).csv pbs-report.cleaned.$(suffix).csv pbs-report.cleaned.partial.$(suffix).csv cores.$(suffix).csv cores.partial.$(suffix).csv config.R config.pyc config.py data.$(suffix).Rdata users.$(suffix).Rdata storage*.$(suffix).csv user-summary.$(suffix).csv monthly.$(suffix).csv cumulative.$(suffix).csv am-jobs.$(suffix).csv
