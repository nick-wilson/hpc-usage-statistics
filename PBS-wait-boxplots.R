...
gpudata[gpudata$CoresGroup=="241-576","CoresGroup"]<-"11 - 24"
gpudata[gpudata$CoresGroup==">576","CoresGroup"]<-"> 24"
#gpudata$CoresGroup<-factor(gpudata$CoresGroup,c("1","2 - 4","5 - 10","11 - 40","> 40"))
gpudata$CoresGroup<-factor(gpudata$CoresGroup,c("1","2 - 4","5 - 10","11 - 24"))
